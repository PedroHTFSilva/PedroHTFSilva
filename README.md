<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0078D6&height=200&section=header&text=Network%20Defense&fontSize=50&animation=fadeIn&fontAlignY=35&desc=Infraestrutura%20e%20Ciberseguranca&descSize=20&descAlignY=60" width="100%"/>
</div>
...
"A segurança não é um produto, é um processo." — Bruce Schneier  </p>
  ...
  <a href="mailto:phfontessilva@hotmail.com">
    <img src="https://img.shields.io/badge/Email-Fale%20Comigo-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
...
| Projeto | Tecnologia | Foco |
| :--- | :---: | :--- |
| **🛡️ DDoS Mitigation PoC** | `C#` `.NET` | Simulação de algoritmos de Rate Limiting e defesa Layer 7. |
| **📡 ISP Network Diagnostics** | `Python` | Automação para análise de logs e falhas de conexão. |
| **🔒 Server Hardening** | `Infra` | Documentação de segurança defensiva para servidores. |
